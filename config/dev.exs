...
config :spotlight, Spotlight.Repo,
  database: Path.expand("../spotlight_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :spotlight, SpotlightWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "U4vp/NKoBMbVdo2lNjHPAogHoedet9te69NUv7NJrRT8yc7zhf35anHjJWnjTSqi",
  watchers: [
...
config :spotlight, SpotlightWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/spotlight_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
